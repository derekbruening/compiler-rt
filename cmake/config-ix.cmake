...
set(ALL_CFSAN_SUPPORTED_ARCH ${X86_64})
...
if(APPLE)
  ...
  list_intersect(CFI_SUPPORTED_ARCH
    ...
    SANITIZER_COMMON_SUPPORTED_ARCH)
  list_intersect(CFSAN_SUPPORTED_ARCH
    ALL_CFSAN_SUPPORTED_ARCH
    SANITIZER_COMMON_SUPPORTED_ARCH)
else()
  ...
  filter_available_targets(CFSAN_SUPPORTED_ARCH ${ALL_CFSAN_SUPPORTED_ARCH})
endif()
...
if (COMPILER_RT_HAS_SANITIZER_COMMON AND CFI_SUPPORTED_ARCH AND
    OS_NAME MATCHES "Linux")
  set(COMPILER_RT_HAS_CFSAN TRUE)
else()
  set(COMPILER_RT_HAS_CFSAN FALSE)
endif()
